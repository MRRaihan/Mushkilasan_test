...
public function benefitpay_request()
  {
    removeTag($this->input->get());
    $params = $this->input->post();
    // var_dump($params);
    ...
    $Pipe->setresponseURL("https://mushkilasan.com/user/Dashboard/benefitpay_response");
    $Pipe->seterrorURL("https://mushkilasan.com/user/Dashboard/error");
    ...
    $Pipe->setudf2($user_name);
    $Pipe->setudf3($user_token);
  ...
  public function benefitpay_response()
  {
    require_once("BenefitAPIPlugin.php");
    ...
    if ($trandata != "")
    {
      ...
      if ($returnValue == 1)
      {
        ...
        {
          echo("REDIRECT=https://mushkilasan.com/user/Dashboard/benefitpay_approved");
        }
        else if ($Pipe->getresult() == "NOT CAPTURED" || $Pipe->getresult() == "CANCELED" || $Pipe->getresult() == "DENIED BY RISK" || $Pipe->getresult() == "HOST TIMEOUT")
        {
          ...
          echo "REDIRECT=https://mushkilasan.com/user/Dashboard/benefitpay_declined";
        }
        else
        {
          //Unable to process transaction temporarily. Try again later or try using another card.
          echo "REDIRECT=https://mushkilasan.com/user/Dashboard/error_response";
        }
      }
      else
      {
  ...
  public function benefitpay_approved()
  {
    require_once("BenefitAPIPlugin.php");
  ...
  public function benefitpay_declined()
  {
    require_once("BenefitAPIPlugin.php");
