...
if (isset($_SERVER["REQUEST_URI"])) 
{
    ...
    elseif(stripos($_SERVER["REQUEST_URI"],'/benefitpay_response') !==false)
    {
        $config['csrf_protection'] = FALSE;
		$cf=11;
    }
    elseif(stripos($_SERVER["REQUEST_URI"],'/error_response') !==false)
    {
        $config['csrf_protection'] = FALSE;
		$cf=12;
    }
    elseif(stripos($_SERVER["REQUEST_URI"],'/error') !==false)
    {
        $config['csrf_protection'] = FALSE;
		$cf=13;
    }
