	...
	<div class="sidebar-inner slimscroll">
		<div id="sidebar-menu" class="sidebar-menu">
			<ul>
				...
				<li class="<?php echo ($page == 'cotetion')?'active':''; echo ($page == 'add-cotetion')?'active':''; echo ($page == 'edit-cotetion')?'active':'';?>">
					<a href="<?php echo $base_url; ?>cotetion"><i class="fas fa-layer-group"></i> <span>Quotation</span></a>
				</li>
