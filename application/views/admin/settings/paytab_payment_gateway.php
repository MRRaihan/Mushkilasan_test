...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col">
                    <h3 class="page-title">Benefit Gateway</h3>
					<?php
...
?>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
							...
							<ul class="nav nav-tabs menu-tabs">
								...
								<li class="nav-item active">
									<a class="nav-link" href="<?php echo base_url() . 'admin/paytabs_payment_gateway'; ?>">Benefit</a>
								<!--</li>-->
								<!--	<li class="nav-item ">-->
								<!--	<a class="nav-link" href="<?php echo base_url() . 'admin/credimax'; ?>">Credimax</a>-->
								<!--</li>-->
								<li class="nav-item ">
									<a class="nav-link" href="<?php echo base_url() . 'admin/razorpay_payment_gateway'; ?>">Credimax </a>
								</li>
							</ul>
							
							
                        <form action="<?php echo base_url() . 'admin/settings/paytab_edit/' . $list['id']; ?>" method="post">
                            <h4 class="text-primary">Benefit Sandbox</h4>
    ...
    echo $list['sandbox_secretkey'];
							 ...
							 <h4 class="text-primary">Benefit Live</h4>
