...
<div class="content">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-9 col-md-8">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        ...
                        // print_r($user_name);
                        // print_r($user_token);
                        // print_r($currency_type);
                        ?>

                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Add Wallet</h4>
                                <form action="https://paymentgateway.mushkilasan.com" id="benefitpay_form">
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            ...
                                            <!--<input type="hidden"  id="currency_type" name="currency_type"  value="<?= $currency_type; ?>">-->
                                            <input type="hidden"  id="chat_token" name="chat_token"  value="<?= $this->session->userdata('chat_token'); ?>">
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                          <input class="form-check-input" type="radio" name="payment_type" id="benefitpay" value="benefitpay">
                                          <img src="<?= base_url() . "assets/img/benefitpay.png"; ?>" style="width: 85%">
                                        </div>
                                    </div>
                                    <br>
                                </div>
								...
								<!--<input type="hidden" id="razorpay_apikey" value="a0a2f6137fa8fd869b87f30223df5821">-->
            ...
            <!-- Benefitpay Form -->
            <form method="POST" action="<?php echo base_url() . "user/Dashboard/benefitpay_request" ?>" id="benefitpay_form">
...
?>
    ...
    <script>
        ...
        $('#benefitpay').click(function () {
            const benefitpay = $(this).val();
            // alert(benefitpay);
            if (benefitpay === 'benefitpay') {
              $('#stripe_wallet').show();
              $('#stripe_wallet').css('background', '#E4111B');
              $('#stripe_wallet').css('border', '1px solid #E4111B');
              
              $("#stripe_wallet").click(function(){
                $("#paytab_payment").submit(); // Submit the form
              });
            } else {
              $('#stripe_wallet').hide();
            }
