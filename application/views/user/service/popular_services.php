							...
							<div class="service-content">
								...
								<div class="user-info">
									<div class="row">
										...
										<span class="col ser-location"> <span class="col ser-location"><span><?php echo ucfirst($srows['service_location']); ?></span> <i class="fas fa-map-marker-alt ml-1"></i></span> <i class="fas fa-map-marker-alt ml-1"></i></span>
									</div>
								</div>
							</div>
						</div>
