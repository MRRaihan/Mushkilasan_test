...
class BenefitPayController extends Controller
{
    protected $msg = array();
...
//
    ...
    public function pay(Request $request)
    {
        ...
        $redirect_url = 'https://benefitpay.mushkilasan.com/benefit/done';

        $error_url = 'https://benefitpay.mushkilasan.com/fail';
...
//        $order_id = Session::get('order_id');
        ...
        $Reqship_To_Postalcd = "ship_To_Postalcd=" . $postal_code . "&";
        ...
        $Reqcard_PostalCd = "card_PostalCd=" . $postal_code . "&";
